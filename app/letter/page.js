...
const LetterPage = () => {
  return (
    <div className='mt-12 max-w-3xl px-4 w-full flex flex-col gap-y-4 items-center'>
      ...
      <iframe className='rounded-[12px]' src="https://open.spotify.com/embed/track/0KyzXQhY2yzcb1FYCHkZc2?utm_source=generator&theme=0" width="100%" height="152" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
    </div>
  )
}
